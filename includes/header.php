...
<head>
    ...
    <link rel="stylesheet"
        href="<?= (strpos($_SERVER['PHP_SELF'], '/pages/') !== false) ? '../pages/css/style.css' : 'pages/css/style.css' ?>" />
...
<body>
    ...
    <header class="main-header">
        ...
        <div class="search-container">
            <form
                action="<?= (strpos($_SERVER['PHP_SELF'], '/pages/') !== false) ? '../search_results.php' : 'search_results.php' ?>"
    ...
    <script
        src="<?= (strpos($_SERVER['PHP_SELF'], '/pages/') !== false) ? '../pages/js/script.js' : 'pages/js/script.js' ?>"></script>
    <script>
